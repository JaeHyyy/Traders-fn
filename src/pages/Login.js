...
function Login() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        axios.post('http://192.168.0.109:8090/traders/login', credentials)
            // axios.post('http://10.10.10.153:8090/traders/login', credentials)
            .then(response => {
                ...
                axios.get(`http://192.168.0.109:8090/traders/branchname/${credentials.branchId}`, {
                    headers: {
