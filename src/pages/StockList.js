...
const StockList = () => {
  const columns = [
    ...
    //render를 써서 가져와야한다
    // { header: "이미지", accessor: 'goods.gimage', render: (row) => <img src={`http://10.10.10.31:8090/traders/images/items/${row.goods.gimage}.png`} alt={row.goods.gname} style={{ width: '50px', height: '50px' }} /> },
