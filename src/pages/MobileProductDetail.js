...
const MobileProductDetail = () => {
        ...
        const fetchProductDetails = async () => {
            try {
                ...
                const [response1, response2, response3] = await Promise.all([
                    axios.get(`http://10.10.10.170:8090/traders/stock/gcode-data/${gcode}`),
                    // axios.get(`http://192.168.0.109:8090/traders/stock/gcode-data/${gcode}`),

                    axios.get(`http://10.10.10.170:8090/traders/goods/${gcode}`),
                    // axios.get(`http://192.168.0.109:8090/traders/goods/${gcode}`),

                    axios.get(`http://10.10.10.170:8090/traders/movement/${gcode}`)
    ...
    const updateLocation = async () => {
        try {
            ...
            // API 요청을 통해 위치 업데이트
            const response = await axios.put('http://10.10.10.170:8090/traders/stock/mobile-update-location', null, {
